...
public class PagerSlidingTab extends HorizontalScrollView {
    ...
    //	private int indicatorColor = 0xFF8adefe;//线的颜色
    private int indicatorColor = getResources().getColor(R.color.radio_text_check);//线的颜色
    ...
    public PagerSlidingTab(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabBackgroundResId = a.getResourceId(R.styleable.PagerSlidingTab_tabBackground_tab, tabBackgroundResId);
        ...
        public void onPageSelected(int position) {
            ...
            for (int i = 0; i < tabCount; i++) {
                ...
                if (v instanceof TextView) {
                    ...
                    textView.setTextColor(i == pager.getCurrentItem() ? getResources().getColor(R.color.white) : tabTextColor);
                }
            }
        }
    }
