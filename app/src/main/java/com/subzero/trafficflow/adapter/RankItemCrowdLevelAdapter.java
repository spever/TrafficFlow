 ...
 */
public class RankItemCrowdLevelAdapter extends BaseAdapter {
    private ArrayList<CrowdLevel> listRank;
    private Context context;

    public RankItemCrowdLevelAdapter(ArrayList<CrowdLevel> listRank, Context context) {
        this.listRank = listRank;
        this.context=context;
    }

    public RankItemCrowdLevelAdapter(Context context) {
        this.listRank = new ArrayList<CrowdLevel>();
        this.context=context;
    }
    ...
    public void addItem(List<CrowdLevel> list){
        this.listRank.addAll(list);
        notifyDataSetChanged();
    }
    public void refreshItem(List<CrowdLevel> list){
        this.listRank.clear();
        this.listRank.addAll(list);
        notifyDataSetChanged();
    }

    public List<CrowdLevel> getList() {
        return listRank;
    }
    ...
    public View getView(int position, View convertView, ViewGroup arg2) {
        ...
        CrowdLevel ac = listRank.get(position);
