...
import com.subzero.trafficflow.activity.ChooseDistrictActivity;
 ...
 */
public class DistrictFragment extends BaseFragment implements RadioGroup.OnCheckedChangeListener, View.OnClickListener {
    ...
    protected View initView() {
        ...
        v = View.inflate(getActivity(), R.layout.fragment_district, null);
        initId();
        initListener();
        return v;
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.id_iv_choose:
                Intent intent = new Intent();
                intent.setClass(getActivity(), ChooseDistrictActivity.class);
