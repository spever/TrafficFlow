...
public class StringUtils {
	...
	/**给TextView设置Text*/
	public static void setText2Button(View view, String text){
		Button button = (Button)view;
		if((button!=null) && (text!=null) && (!"null".equalsIgnoreCase(text))){
	...
	/**给EditText设置Text*/
	public static String getTextFromEditText(View view){
